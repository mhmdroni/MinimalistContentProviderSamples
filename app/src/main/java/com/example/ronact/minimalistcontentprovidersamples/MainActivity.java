...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickDisplayEntries(View view){
        String queryUri = Contract.CONTEN_URI.toString();
        ...
        Cursor cursor =
                getContentResolver().query(Uri.parse(queryUri), projection, selectionClause, selectionArgs, sortOrder);
        if (cursor !=null){
            ...
            Log.d(TAG, "onClickDisplayEntries " + "Cursor id null.");
